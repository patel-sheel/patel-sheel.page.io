...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(0.61, 0.32, 0.11, 1.0);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.3f, 0.2f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 2.7f, 0.5f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.1f, 0.7f, 0.1f); 
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.0f, 1.8f, 0.5f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.18f, 0.18f, 0.13f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.85f, 2.2f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-7.85f, 1.9f, 0.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.0f, 0.0f, -6.0f);
	...
	*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.0f, 5.0f, -6.0f);
	...
	*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.5f, 6.1f, -6.0f);
	...
	*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.64f, 6.55f, -6.0f);
	...
	*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.68, 6.68f, -6.0f);
	...
	*/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-12.7f, 6.8f, -6.0f);
